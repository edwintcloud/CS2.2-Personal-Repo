...
class GraphTest(unittest.TestCase):
    ...
    def test_input_type_incorrect(self):
        self.assertRaisesRegex(
            Exception,
            "Expected input file to have a type of G or D for line 1",
            Graph,
    ...
    def test_empty_file(self):
        self.assertRaisesRegex(
            Exception,
            "Expected input file to contain at least 3 lines",
            Graph,
    ...
    def test_edge_incorrect(self):
        self.assertRaisesRegex(
            Exception,
            "Expected input file edge specification to have 2 or 3 items",
            Graph,
    ...
    def test_basic_input(self):
        ...
        self.assertCountEqual(
            result_graph.get_vertices(), ['1', '2', '3', '4']
        )
    ...
    def test_extra_vertex(self):
        ...
        self.assertCountEqual(
            result_graph.get_vertices(), ['1', '2', '3', '4', '6']
        )

        self.assertEqual(4, result_graph.num_edges)
        self.assertCountEqual(
            [('1', '2', 1), ('1', '3', 1), ('2', '4', 1), ('2', '6', 1)],
            result_graph.get_edges(),
        )
    ...
    def test_unused_vertex(self):
        ...
        self.assertEqual(5, result_graph.num_vertices)
        self.assertCountEqual(
            result_graph.get_vertices(), ['1', '2', '3', '4', '5']
        )
    ...
    def test_weighted(self):
        ...
        self.assertEqual(5, result_graph.num_vertices)
        self.assertCountEqual(
            result_graph.get_vertices(), ['1', '6', '10', '15', '21']
        )
